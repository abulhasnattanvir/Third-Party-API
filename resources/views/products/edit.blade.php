    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav class="flex items-center gap-2 text-sm text-gray-500 mb-6">
            ...
            <a href="{{ route('products.show', $product['id']) }}"
                class="hover:text-blue-600 transition-colors truncate max-w-[160px]">
                {{ $product['name'] }}
            </a>
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            ...
            <div class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
                ...
                <div class="px-6 py-5 space-y-5">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4" placeholder="Enter product description..."
                            class="w-full px-4 py-2.5 text-sm border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition resize-none">{{ old('description', $product['description'] ?? '') }}</textarea>
                    </div>
                ...
                <div class="px-6 py-5">
                    ...
                    @if (!empty($product['image']))
                        <div class="flex items-center gap-4 mb-4 p-3 bg-gray-50 border border-gray-200 rounded-xl">
                    ...
                    <div
                        ...
                        <p class="text-sm text-gray-500 mb-1">Click to upload new image</p>
                ...
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
                    ...
                    <button type="submit"
                        class="inline-flex items-center gap-2 bg-amber-500 hover:bg-amber-600 active:scale-95 text-white text-sm font-medium px-6 py-2.5 rounded-xl transition-all duration-150 shadow-sm">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
